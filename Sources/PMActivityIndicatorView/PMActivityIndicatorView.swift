...
public class PMActivityIndicatorView {
  public static let shared = PMActivityIndicatorView()
...
// MARK: - Public - Start/Stop indicator
public extension PMActivityIndicatorView {
